...
export const NavBar: FC = () => {
  ...
  return (
    <div className="bg-secondary border-text/30 sticky top-0 left-0 z-50 flex w-screen flex-col flex-row justify-between border-b-4 p-4">
      <Drawer swipeDirection="left" open={isOpen} onOpenChange={setIsOpen}>
        ...
        />
        <DrawerContent className="border-text/30 flex h-full flex-col border-r-4">
