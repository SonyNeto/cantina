...
import type { Item, Register } from './types';
...
export const REGISTERS: Registers = {
  REGISTERS: [
    {
      id: `register-${STUDENTS_IDS.aluno1}-${MENU_ITEMS.cake.id}-${dayjs('2026-06-15').format('DD/MM')}`,
    ...
    {
      id: `register-${STUDENTS_IDS.aluno1}-${MENU_ITEMS.mango.id}-${dayjs('2026-06-15').format('DD/MM')}`,
    ...
    {
      id: `register-${STUDENTS_IDS.aluno1}-${MENU_ITEMS.bread.id}-${dayjs('2026-06-12').format('DD/MM')}`,
    ...
    {
      id: `register-${STUDENTS_IDS.aluno2}-${MENU_ITEMS.bread.id}-${dayjs('2026-06-15').format('DD/MM')}`,
      product: MENU_ITEMS.bread,
      created_at: dayjs('2026-06-15').format('DD/MM'),
    ...
    {
      id: `register-${STUDENTS_IDS.aluno3}-${MENU_ITEMS.cake.id}-${dayjs('2026-06-15').format('DD/MM')}`,
      product: MENU_ITEMS.cake,
      created_at: dayjs('2026-06-15').format('DD/MM'),
    ...
    {
      id: `register-${STUDENTS_IDS.aluno4}-${MENU_ITEMS.cake.id}-${dayjs('2026-06-15').format('DD/MM')}`,
      product: MENU_ITEMS.cake,
      created_at: dayjs('2026-06-15').format('DD/MM'),
